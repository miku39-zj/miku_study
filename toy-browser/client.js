  ...
  send(connection) {
    return new Promise((resolve, reject) => {
      ...
      connection.on('data', (data) => {
        ...
        console.log(parser.statusLine,222);
        console.log(parser.headers,222);
  ...
  receiveChar(char) {
    if (this.current === this.WAITING_STATUS_LINE) {
      ...
      if (char === ':') {
        ...
        console.log(this.headers['Transfer-Encoding'],"this.headers['Transfer-Encoding']");
